...
void Solve() {
    ...
    sort(all(r));
    do {
        int l0 = r[0].fi, b0 = r[0].se;
        int l1 = r[1].fi, b1 = r[1].se;
        int l2 = r[2].fi, b2 = r[2].se;

        if (b0 == s && b1 == s && b2 == s && l0 + l1 + l2 == s)
            ok = true;
        else if (l0 == s && l1 == s && l2 == s && b0 + b1 + b2 == s)
            ok = true;
        else if (l0 == s && b0 + b1 == s && b0 + b2 == s && l1 + l2 == s)
            ok = true;
        else if (b0 == s && l0 + l1 == s && l0 + l2 == s && b1 + b2 == s)
            ok = true;
